  ...
  <div class="cotainer">
    <div class="cotainer-center flt_ce">
	  ...
	  <?php
		...
		if(isset($_GET['valid'])){
			if ($_GET['valid'] == "no"){
				echo "<p align='center'>Usuário e/ou senha inválidos. Clique <a href='index.php'>aqui</a> para fechar esta mensagem!</p>";
			}elseif ($_GET['valid'] == "cad_yes"){
				echo "<p align='center'>Cadastro realizado com sucesso. Efetue login. Clique <a href='index.php'>aqui</a> para fechar esta mensagem!</p>";
			}elseif ($_GET['valid'] == "cad_no"){
				echo "<p align='center'>Ocorreu um erro em seu cadastro. Clique <a href='index.php'>aqui</a> para fechar esta mensagem!</p>";
			}elseif ($_GET['valid'] == "exists"){
				echo "<p align='center'>Já existe um usuário com este login. Escolha um outro login. Clique <a href='index.php'>aqui</a> para fechar esta mensagem!</p>";
			}
		}
      ...
      <p><form name="frmCadastro" method="post" action="validarCadastro.php" onSubmit="return validaCadastro(this)">
